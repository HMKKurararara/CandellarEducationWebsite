...
export async function GET() {
  ...
  try {
    const response = await fetch(`https://graph.facebook.com/${version}/${id}/posts?fields=id,message,full_picture,permalink_url,created_time&limit=6&access_token=${token}`, { next:{revalidate:3600} })
